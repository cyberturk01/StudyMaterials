...
public class PrintConsecutiveNumbers {
	 ...
	 * given order. For example, numbers divisible by both 2 and 3 should be replace
	 * by CodilityTest and numbers divisible by all three numbers: 2,3 and 5, should 
